from PySide6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QFrame, QCheckBox, QComboBox, QTextEdit, QPushButton
...
class AdvancedSettingsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        layout.addWidget(QLabel("<span style='font-weight: 600;'>输入应用名称关键词 (每行一个)</span><br><span style='color: #94A3B8; font-size: 12px;'>例如输入 'League' 或 'AutoCAD'</span>"))
